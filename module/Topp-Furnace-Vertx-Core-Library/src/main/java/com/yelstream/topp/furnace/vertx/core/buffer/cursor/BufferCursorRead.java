...
import com.yelstream.topp.furnace.vertx.core.buffer.excile.cursor.assist.AbstractCursorRead;
...
public final class BufferCursorRead extends AbstractCursorRead<BufferCursor,BufferCursorRead,BufferCursorWrite> {
    ...
    public BufferCursorGet get() {
        return new BufferCursorGet(this,buffer,space,slide);
    }
